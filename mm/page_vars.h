//
// Created by boran on 12.11.2016.
//
...
#ifndef BORIX_PG_VARS_H
#define BORIX_PG_VARS_H

#define	KERN_PDIR			0x00001000  //kernel page directory
...
#define KERN_PG_1			0x400000    // Kernel page 1 4mb
